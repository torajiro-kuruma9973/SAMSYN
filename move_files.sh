...
# ================= 配置区 =================
N=500                                  # 设定的阈值 N
SRC_DIR="/mnt/c/Users/xiaow/Documents/Work/NBIA-PSMA-manifest-1772126181965/super_segs/"      # 源文件夹绝对路径 (替换为实际路径)
DEST_DIR="/mnt/c/Users/xiaow/Documents/Work/NBIA-PSMA-manifest-1772126181965/super_segs_backup/"     # 目标文件夹绝对路径 (替换为实际路径)
